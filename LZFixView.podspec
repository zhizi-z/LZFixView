#
#  Be sure to run `pod spec lint LZFixView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
A new verison for absorption views to top, left, bottom, or right of an instance of UIScrollView.
                   DESC

  s.homepage     = "https://github.com/zhizi-z/LZFixView"
